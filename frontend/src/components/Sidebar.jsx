import { FaUsers, FaChartLine, FaSignOutAlt, FaTimes } from "react-icons/fa";
...
function Sidebar({ sidebarOpen, setSidebarOpen, handleLogout }) {
  ...
  return (
    <>
      ...
      <div
        className={`fixed md:static top-0 left-0 z-50 h-screen w-72 bg-white border-r border-zinc-200 flex flex-col justify-between p-6 transition-transform duration-300 ${
      ...
      >
        <div>
          <div className="flex items-center justify-between mb-10">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs font-medium text-zinc-500">Lead Management</p>
              </div>
            </div>
          ...
          <ul className="space-y-2">
            <Link to="/dashboard">
              <li
                className={`px-4 py-3 rounded-xl text-sm font-medium cursor-pointer flex items-center gap-3 transition-all duration-200 ${
